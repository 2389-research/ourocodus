#!/bin/bash
# demo-setup.sh - One-time setup for Container Session demo
...
echo "=========================================="
echo "  Container Session Demo - Setup"
echo "=========================================="
echo
...
if go build -o containersession-demo main.go; then
    echo -e "${GREEN}✓ Demo binary built${NC}"
    ls -lh containersession-demo
else
